...
public class Ejercicio4_NGF {
	...
	public static void main(String[] args) {
		...
		s=letra.next(); //s es igual a lo que se introduce por teclado
		s1 = s.toLowerCase(); // s1 es igual a lo introducido, pero convertido a minusculas

		if(!(s.equals(s1))) { //si s no es igual a s1
